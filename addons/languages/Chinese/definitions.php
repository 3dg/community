...
ET::$languageInfo["Chinese"] = array(
	...
	"author" => "esotalk",
	"authorEmail" => "admin@rkidc.net",
	"authorURL" => "esotalk.rkidc.net",
	"license" => "GPLv2"
);
...
$definitions["%d month ago"] = "%d 个月前";
$definitions["%d months ago"] = "%d 个月前";
$definitions["%d second ago"] = "刚刚";
$definitions["%d seconds ago"] = "%d 秒前";
$definitions["%d week ago"] = "%d 周前";
$definitions["%d weeks ago"] = "%d 周前";
$definitions["%d year ago"] = "%d 年前";
$definitions["%d years ago"] = "%d 年前";

$definitions["%s and %s"] = "%s 以及 %s";
$definitions["%s can view this conversation."] = "%s 可以查看这个话题。";
$definitions["%s changed %s's group to %s."] = "%s 更改 %s 的小组到 %s。";
$definitions["%s changed your group to %s."] = "%s 更改你的小组到 %s。";
$definitions["%s conversation"] = "%s 个话题";
$definitions["%s conversations"] = "%s 个话题";
$definitions["%s has registered and is awaiting approval."] = "%s 已注册，等待审核。";
$definitions["%s invited you to %s."] = "%s 邀请你 %s。";
$definitions["%s joined the forum."] = "%s 加入论坛。";
$definitions["%s mentioned you in %s."] = "%s 在 %s 提到你。";
$definitions["%s posted %s"] = "%s 发布于 %s";
$definitions["%s posted in %s."] = "%s 回复 %s。";
$definitions["%s post"] = "%s 次发言";
$definitions["%s posts"] = "%s 次发言";
$definitions["%s reply"] = "%s 条回复";
$definitions["%s replies"] = "%s 条回复";
$definitions["%s Settings"] = "%s 设置";
$definitions["%s started the conversation %s."] = "%s 发起话题 %s。";
$definitions["%s will be able to view this conversation."] = "%s 可以看到这个话题。";
$definitions["%s will be able to:"] = "%s 可以:";

$definitions["A new version of esoTalk (%s) is available."] = "新版 esoTalk (%s) 已经发布。";
...
$definitions["Choose a secure password of at least %s characters"] = "请设置一个至少 %s 字符的安全密码";
...
$definitions["If you run into any other problems or just want some help with the installation, feel free to ask for assistance at the <a href='%s'>esoTalk support forum</a>."] = "如果你有问题需要帮助，你可以到 <a href='%s'>esoTalk</a> 论坛寻求帮助";
...
$definitions["Ignore conversation"] = "忽视话题";
$definitions["Unignore conversation"] = "取消忽视";
...
$definitions["Page Not Found"] = "找不到该页面";
...
$definitions["Require users to confirm their email address"] = "需要确认 Email 地址";
...
$definitions["Search within this conversation..."] = "在当前话题中搜索……";
$definitions["Search"] = "搜索";
$definitions["See the private conversations I've had with %s"] = "查看我与 %s 的私人话题";
...
$definitions["Start a private conversation with %s"] = "与 %s 开启一个私人话题";
$definitions["Start Conversation"] = "发布";
$definitions["Starting a conversation"] = "关注话题";
$definitions["Statistics"] = "统计";
$definitions["statistic.conversation.plural"] = "话题 %s";
$definitions["statistic.conversation"] = "话题 %s";
$definitions["statistic.member.plural"] = "成员 %s";
$definitions["statistic.member"] = "成员 %s";
$definitions["statistic.online.plural"] = "在线 %s";
$definitions["statistic.online"] = "在线 %s";
$definitions["statistic.post.plural"] = "发言 %s";
$definitions["statistic.post"] = "发言 %s";
...
$definitions["Username or Email"] = "用户名或 Email";
...
$definitions["viewingPosts"] = "<b>%s-%s</b>%s 发布的";
...
$definitions["message.accountNotYetApproved"] = "管理员还没有审核，请耐心等待！";
$definitions["message.ajaxDisconnected"] = "无法访问服务！请稍后进行<a href='javascript:jQuery.ETAjax.resumeAfterDisconnection()'>重试</a>，或者<a href='' onclick='window.location.reload();return false'>刷新</a>.";
...
$definitions["message.esoTalkAlreadyInstalled"] = "<strong>esoTalk 安装完成。</strong><br/><small>如需重新安装，请删除<strong>config/config.php</strong>。</small>";
$definitions["message.esoTalkUpdateAvailable"] = "新版 esoTalk ，%s ，已经发布.";
$definitions["message.esoTalkUpdateAvailableHelp"] = "新版本通常更安全，也附加一些新功能，建议更新。";
$definitions["message.esoTalkUpToDate"] = "你的版本是最新的。";
$definitions["message.esoTalkUpToDateHelp"] = "如果你觉得 esoTalk 好用，请考虑给作者<a href='%s' target='_blank'>捐赠</a>。";
...
$definitions["message.invalidEmail"] = "无效的 Email 地址";
...
$definitions["message.passwordTooShort"] = "密码太短了，至少要 6 位！";
...
$definitions["message.postTooLong"] = "你的说得太多了，已经超过了最大字符数了， 最多支持 %s 字符. ";
...
$definitions["message.registrationClosed"] = "暂不向公众开放注册.";
...
$definitions["message.suspendMemberHelp"] = "屏蔽 %s 将限制他们在论坛里的发布话题及回复行为，仅保留与防客一样的权限.";
...
$definitions["gambit.active 1 day"] = "活跃 1 天"; // what it actually evaluates to

$definitions["gambit.has replies"] = "已回复";
$definitions["gambit.has >0 replies"] = "1 个以上回复";
$definitions["gambit.has >10 replies"] = "10 个以上回复";
