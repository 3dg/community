...
if (file_exists($file = PATH_ROOT."/config.extra.php")) ET::loadConfig($file);
...
// Otherwise, register all the default controllers and admin controllers.
	...
	ETFactory::registerController("uploads", "ETUploadsController", PATH_CONTROLLERS."/ETUploadsController.class.php");
